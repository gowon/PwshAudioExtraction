namespace PwshAudioExtraction.Commands
{
    ...
    [Cmdlet(VerbsData.ConvertTo, Noun, DefaultParameterSetName = ParamSetPath)]
    public class ConvertToTrackArtImage : PSCmdlet
    {
        private const string Noun = "TrackArtImage";
